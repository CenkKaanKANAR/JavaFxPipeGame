...
public class Pane16 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
			Image pipesign = new Image("INFO/infopipe.png");          //In this part of the code,we have created ImageViews that we have used
		  //in the game and arranged them.
			...
			circleplay.setRadius(70);				//Also drapshadow effect was exerted on the play text.
		...
		Text text1 = new Text(20, 20, "PIPER");
		...
		/*PathTransition ptBoardReturn = new PathTransition();
		ptBoardReturn.setDuration(Duration.millis(500));
		ptBoardReturn.setPath(pathReturn);
		ptBoardReturn.setNode(allNodes);*/
		...
		PathTransition ptMain = new PathTransition();
		...
		circleplay.setOnMouseClicked(e -> {
			ptMain.play();
			ptMain.setOnFinished(b -> {
				ptMain.stop();
				ptReturn.play();
